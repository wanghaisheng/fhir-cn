...
HL7制作了大量不像上述所列与FHIR存在重叠的其他标准，主要是因为它们不仅仅关注的是信息的交换。然而，我们大体上提一下： 

####   1.9.4.1 EHR功能模型(EHR-FM)    

这份标准为电子健康档案系统定义了大量的功能。FHIR是一种信息交换的标准，用来满足其中一些系统功能。如何在EHR-FM中使用FHIR [见此](ehr-fm.html)    

####   1.9.4.2 语境管理标准Context Management Specifications (CCOW)     
